...
export default class QuotesSelection  extends RX.Component {
    ...
    onChangePost = () => {
        console.log("Rahul")
                        ...
                        // this.props.onNavigateDetail(liability,quoteid,premium,odpremium,token,rs1,rs2,rs3,rs4,rs5,rs6,rs7,rs8,rs9,rs10,rs11);
          
                        this.props.onNavigateDetail(token)
    ...
    onChangePostt(){
        ...
        this.props.onNavigateNinety(resJson,liability,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium,TotalPremium); 
    }
    render() {
    ...
    //    var rs1=odpremium.PACKAGE_PREMIUM;
    //    var rs2=liability.BASIC_PREMIUM_INCLUDING_PREMIUM_FOR_TPPD;
    //    var rs3=liability.TOTAL_LIABILITY_PREMIUM;
    //    var rs4=liability.TO_EMPLOYESES;
    //    var rs5=liability.TO_PAID_DRIVERS;
    //    var rs6=liability.UNDER_SECTION_III_OWNER_DRIVER;
    //    var rs7=odpremium.PACKAGE_PREMIUM

    //    var rs8=odpremium.POLICY_EXPIRY_DATE
       
       
    //    var rs9=odpremium.POLICY_START_DATE
       
    //   var rs10= odpremium.POLICY_TERM
       
    //    var rs11=odpremium.PREMIUM_WITHOUT_COVERS
       console.log(rs1,"rsss1")
        return (
                                        ...
                                        <Col md={8} xs={8}style={ _styles.client }>
                                            ...
                                            <Col  md={4} xs={4} style={styling.marTop17 }>
                                                ...
                                                <RX.Text style={ styling.sideHead}>
                                                    <div style={styling.tryHead}>IDV:56000</div>
                                                </RX.Text>
                                ...
                                <Col md={12} style={styling.marTop17 }>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col  md={4}></Col>
                                            <Col md={3} >
                                                {/* <RX.Text style={styling.clientHeadts}>RS.{liability.BASIC_PREMIUM_INCLUDING_PREMIUM_FOR_TPPD}</RX.Text> */}
                                                <RX.Text style={styling.clientHeadts}>RS.1456</RX.Text>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>1345</RX.Text>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>560</RX.Text>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>430</RX.Text>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>549</RX.Text>
                        ...
                        <RX.View >
                            <Row className="show-grid" >
                                <Col md={12} style={styling.marTop17 }>
                                    ...
                                    <RX.Text style={styling.clientHeadts}>{4545}
 </RX.Text>
                                            </Col>
                                        </Col>
                                    </RX.View>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>14/09/2019</RX.Text>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>17/09/2018
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>1
</RX.Text>
                                            </Col>
                                        </Col>
                                    </RX.View>
                                    ...
                                    <RX.View>
                                        <Col md={8} style={ _styles.client }>
                                            ...
                                            <Col md={3} >
                                                ...
                                                <RX.Text style={styling.clientHeadts}>1047
                                                </RX.Text>
                                            </Col>
                                        </Col>
                                    </RX.View>
