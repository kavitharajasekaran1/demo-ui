...
export default class QuotesSelection  extends RX.Component {
    ...
    onChangeliabilityy=() => { 
       // this.props.onNavigateliabilityy(liability,resJson,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium,TotalPremium); 
        this.props.onNavigateliabilityy(token)
    }
// onChangebharathi=() =>{
//   //  this.props.onNavigatebharathi(liability,resJson,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium,TotalPremium)
//   this.props.onNavigatebharathi(token)
// }
     onChangeliability = (value) => {
       ...
       // this.props.onNavigateSixth(liability,resJson,message,quoteid,premium,odpremium,token,responseJson1,idv,enquiryId,totalGrossPremium);
        
       this.props.onNavigateSixth(token)
    ...
    render() {
     ...
     console.log(TotalPremium,"hiiiiiiiiiii")
    ...
    // console.log("enquiryID.......kavi.....",enquiryId)
    // console.log("idv...kavi...",idv)
    // console.log("totalpremuim", totalGrossPremium)
            ...
            <RX.Button   onPress={()=> this.onChangePost()}><RX.Image
                ...
                <RX.View style={ _styles.pageAlign }>
                    <RX.View style={ _styles.client }>
                        ...
                        <RX.View style={_styles.nextBtn}>
                            <RX.Button style={ _styles.roundButton } onPress={ () => this.onChangebharathi() }>
                                <RX.Text style={ _styles.buybuttonText }>
...
<RX.View style={ styling.container12 }>
{/* <RX.Button   onPress={()=> this.onChangePost()}><RX.Image */}
            ...
            <RX.Button className="btn btn-default" style={styling.BUTTON41} onPress={()=> this.onChangeliabilityy()}>Compare
