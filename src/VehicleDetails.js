...
export default class VehicleDetails extends React.Component{
   constructor(props) {
        ...
        this.state = {
                      ...
                      idv: '87164',
                      policyStartDate: '31/07/2018',
                      vehicleMostlyDrivenOn: 'Roads',
                      vehicleRegDate: '31/07/2018',
...
console.log("quoteid_",this.props.navigatorRoute.quoteid)
        return fetch('http://localhost:8082/brandnewupdatevehical', {
           ...
           // this.props.onNavigateEight(res);
            ...
            if (Message==="As per notification of IRDA one year Policies are not applicable for Private Car and Two Wheeler New Vehicles wef 01 /09/2018. Kindly contact Royal Sundaram for assistance in new long term product issuance"){
                swal("Quote approved and proceed buy policy")
            // this.props.onNavigateEight(res,quoteid,mypremium,token);
            this.props.onNavigateEight(token);
     ...
     onChangePostt(){
        ...
        console.log(rs2,"rssss22222")
        this.props.onNavigatePush(liability,resJson,message,quoteid,premium,odpremium,token,rs1,rs2,rs3,rs4,rs5,rs6,rs7,rs8,rs9,rs10,rs11); 
    }  
  ...
  onChangeArea = (value) => {
    ...
    render() {
        rs1=this.props.navigatorRoute.rs1
        rs2=this.props.navigatorRoute.rs2
        rs11=this.props.navigatorRoute.rs11
        rs3=this.props.navigatorRoute.rs1
        rs4=this.props.navigatorRoute.rs4
        rs5=this.props.navigatorRoute.rs5
        rs6=this.props.navigatorRoute.rs6
        rs7=this.props.navigatorRoute.rs7
        rs8=this.props.navigatorRoute.rs8
        rs9=this.props.navigatorRoute.rs9
        rs10=this.props.navigatorRoute.rs10
     ...
     resJson = this.props.navigatorRoute.resJson
        ...
        //  liability,resJson,message,quoteid,premium,odpremium,token
